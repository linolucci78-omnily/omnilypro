-- ============================================
-- WEBSITE BUILDER - SIMPLE VERSION
-- Solo le parti essenziali senza policy complesse
-- ============================================
...
-- Crea tabella contact form submissions
...
-- SOLO POLICY PUBBLICA PER IL FORM
...
-- ============================================
-- FATTO! Ora puoi configurare le altre policy manualmente
-- da Supabase Dashboard se serve controllo accessi
-- ============================================
