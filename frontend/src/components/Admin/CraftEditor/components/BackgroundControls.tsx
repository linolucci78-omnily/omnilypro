          ...
          <div>
            ...
            <div style={{ marginBottom: '16px' }}>
              <label style={{
                ...
                borderRadius: '8px',
                border: '1.5px solid #e5e7eb',
                background: (settings.backgroundAttachment === 'fixed') ? '#eff6ff' : '#ffffff',
                transition: 'all 0.2s'
              }}>
                <input
                  type="checkbox"
                  checked={settings.backgroundAttachment === 'fixed'}
                  onChange={(e) => updateSetting('backgroundAttachment', e.target.checked ? 'fixed' : 'scroll')}
                  style={{ width: '18px', height: '18px', cursor: 'pointer' }}
                />
                <Move size={16} color={settings.backgroundAttachment === 'fixed' ? '#3b82f6' : '#6b7280'} />
                <span style={{
                  fontSize: '14px',
                  fontWeight: '500',
                  color: settings.backgroundAttachment === 'fixed' ? '#3b82f6' : '#374151'
                }}>
                  Effetto Parallasse
                </span>
              </label>
              <p style={{ fontSize: '11px', color: '#9ca3af', margin: '6px 0 0 0', paddingLeft: '4px' }}>
                L'immagine rimane fissa durante lo scroll
              </p>
            </div>
          </div>
        )}
