  ...
  const handleGenerateQR = async () => {
    ...
    try {
      ...
      const provisioningData = {
        ...
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_PACKAGE_CHECKSUM": "PHmH7mLjxOyxdLbm2K9ZBODYQKCpjTzSH8W3ob01gn8",
        "android.app.extra.PROVISIONING_DEVICE_ADMIN_SIGNATURE_CHECKSUM": "tsNKw-dZ_gG0qYS3nlmLOsaQl0E_yuEo13BhMZ7af2E",
