...
export function MovingBorder({
  ...
  return (
    ...
    >
      ...
      >
        <div className="h-4 w-4 rounded-full bg-gradient-to-r from-red-500 to-pink-500 blur-sm" />
      </motion.div>
      {children}
    </div>
  )
...
>(({ borderRadius = "1.75rem", children, borderClassName, containerClassName, duration, className, ...otherProps }, ref) => {
  return (
    <button
      ref={ref}
      className={cn(
