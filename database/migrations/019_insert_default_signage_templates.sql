    ...
    '{
        "zones": [
            ...
            },
            {
                "id": "right-text",
                "type": "text",
                "content": "Il tuo messaggio qui\n\nAggiungi dettagli sulla tua promozione",
                "style": {
                    "fontSize": "2rem",
                    "color": "#1f2937",
        ...
        "zones": [
            {
                "id": "announcement-text",
                "type": "text",
                "content": "Il tuo annuncio importante",
                "style": {
                    "fontSize": "4rem",
                    "fontWeight": "bold",
                    "textAlign": "center",
...
INSERT INTO signage_templates (
    ...
    NULL,
    'Menù Ristorante',
    'Layout per menù con titolo e contenuto',
    'menu',
    TRUE,
    TRUE,
    '{
...
COMMENT ON TABLE signage_templates IS 'Pre-built and custom slide templates for digital signage';
