...
async function uploadAPK() {
  ...
  console.log('📦 Reading new APK file (v1.3.6 with fixed permissions)...');
  const fileBuffer = fs.readFileSync(apkPath);

  console.log('☁️  Uploading to Supabase storage (overwriting omnilybridgepos-production.apk)...');
  ...
  console.log('🎉 Done! Version 1.3.6 with:');
  console.log('   - targetSdkVersion 34 (Android 14)');
  console.log('   - Removed READ_PHONE_STATE permission');
  console.log('   - Removed BLUETOOTH_SCAN/BLUETOOTH_CONNECT permissions');
  console.log('   - Removed REBOOT permission');
}
