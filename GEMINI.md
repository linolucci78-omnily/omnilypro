...
This file helps Gemini understand the specifics of your project.
...
You can list common commands here so Gemini can use them.
...
(Describe the project structure. Are there any important files or directories Gemini should pay special attention to?)
