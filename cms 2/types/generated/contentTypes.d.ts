...
export interface ApiOrganizationWebsiteOrganizationWebsite
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contenuto: Schema.Attribute.JSON & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    custom_domain: Schema.Attribute.String;
    is_maintenance: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    organization_id: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiWebsiteTemplateWebsiteTemplate
  ...
  attributes: {
    anteprima: Schema.Attribute.Media<'images'>;
    categoria: Schema.Attribute.Enumeration<
      ['ristorante', 'bar', 'negozio', 'servizi', 'beauty', 'altro']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'ristorante'>;
    component_path: Schema.Attribute.String & Schema.Attribute.Required;
    contenuto_default: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descrizione: Schema.Attribute.Text;
    editable_fields: Schema.Attribute.JSON & Schema.Attribute.Required;
    ...
    nome: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    sezioni: Schema.Attribute.DynamicZone<
      [
        'sections.hero',
        'sections.menu',
        'sections.gallery',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::organization-website.organization-website': ApiOrganizationWebsiteOrganizationWebsite;
